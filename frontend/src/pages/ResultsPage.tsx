      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
          <div className="flex items-center gap-3">
            <h1 className="text-xl md:text-2xl font-bold" style={{ color: 'var(--text-primary)' }}>Results</h1>
            {sessionId.startsWith('demo_') && (
              <span className="px-2 py-0.5 text-xs font-bold rounded-full" style={{ background: 'var(--accent-purple)', color: '#fff' }}>
                DEMO DATA
              </span>
            )}
          </div>
