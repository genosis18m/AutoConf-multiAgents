// Static demo data bundled with the frontend — no backend needed
import type { AllResults } from '../types'

export const DEMO_DATA: Record<string, AllResults> = {
  delhi: {
    sponsor: {
      sponsors: [
        {
          ...
          outreach_email: "Subject: Partnership for AI Summit India\n\nHi Team,\n\nWe would love to have Google Cloud as our presenting sponsor for the AI Summit Delhi."
        },
        {
          rank: 2,
          ...
          outreach_email: "Subject: Sponsorship Opportunity - AI Summit India\n\nHi Team,\n\nWe believe Infosys would be a great fit for our AI Summit Delhi."
        }
      ],
      total_found: 15,
    ...
    gtm: {
      ...
      timeline: [
        { week: "Pre-launch", action: "Teaser campaign on LinkedIn" },
        { week: "Launch", action: "Early bird ticket announcement" }
      ],
  ...
  new_york: {
      ...
      sponsors: [
        {
          ...
          outreach_email: "Subject: Partnership for SaaS Growth Summit NY\n\nHi Team,\n\nWe would love to have Stripe as a sponsor for our New York summit."
        },
        {
          rank: 2,
    ...
    gtm: {
      ...
      timeline: [
        { week: "Pre-launch", action: "Announce speakers" },
        { week: "Launch", action: "Open ticket sales" }
      ],
